...
if __name__ == "__main__":
    ...
    os.environ["ZOOINIT_CLUSTER_EVENT"] = "OnStart"
    os.environ["ZOOINIT_SERVER_IP_LIST"] = "192.168.4.123,192.168.4.220,192.168.4.221"
    os.environ["ZOOINIT_LOCAL_IP"] = "192.168.4.123"
    os.environ["ZOOINIT_MASTER_IP"] = "192.168.4.123"
